...
class hirerRequest extends StatefulWidget {
  hirerRequest({
    super.key,
  });
  ...
  @override
  State<hirerRequest> createState() => hirerRequestState();
}

class hirerRequestState extends State<hirerRequest> {
  //Filters
            ...
            flexibleSpace: Container(
                decoration: const BoxDecoration(
                    gradient: LinearGradient(
                        ...
                        stops: [0.0, 1.0],
                        tileMode:
                            TileMode.clamp))), //Right corner filter button
            actions: <Widget>[],
            /////////////
